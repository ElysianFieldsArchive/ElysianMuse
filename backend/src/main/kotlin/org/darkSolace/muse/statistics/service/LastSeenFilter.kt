...
/**
 * Filter to create or update [org.darkSolace.muse.statistics.model.LastSeenEntry] for each request
 *
...
class LastSeenFilter : OncePerRequestFilter() {
    ...
    /**
     * Creates or updates [org.darkSolace.muse.statistics.model.LastSeenEntry]s during the request
     */
