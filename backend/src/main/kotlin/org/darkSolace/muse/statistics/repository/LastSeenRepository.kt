...
import org.darkSolace.muse.statistics.model.LastSeenEntry
...
interface LastSeenRepository : CrudRepository<LastSeenEntry, User> {
     ...
     *
     * @param deletedUser - the [User] to be used to look up the [LastSeenEntry]
     * @see [org.darkSolace.muse.user.service.UserService.deleteUser]
     */
