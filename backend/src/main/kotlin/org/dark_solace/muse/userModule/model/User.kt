...
data class User(
    ...
    override fun toString(): String {
        return this::class.simpleName + "(id = $id , username = $username , password = $password , email = $email , realName = $realName , signUpDate = $signUpDate , lastLogInDate = $lastLogInDate , bio = $bio , birthday = $birthday , validatedAuthor = $validatedAuthor , onProbation = $onProbation , userSettings = $userSettings , userTags = $userTags , avatar = $avatar , roles = $role )"
    }
}
