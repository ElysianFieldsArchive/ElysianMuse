package org.darkSolace.muse.statisticsModule
...
import org.darkSolace.muse.statisticsModule.service.LastSeenService
...
class LastSeenApiTests : TestBase() {
    ...
    fun generateLastSeenFromJSession() {
        val url = generateUrl("/api/stats/online/count")
    ...
    fun generateLastSeenFromUser() {
        ...
        var url = generateUrl("/api/stats/online/count")
        ...
        url = generateUrl("/api/stats/online")
        val response2 =
