...
class NewsApiTests : TestBase() {
    ...
    fun postNews_AsAdmin() {
        ...
        val secondResponse = restTemplate.postForEntity(
            url2, SignUpRequest("test", "123", "test@example.com"), JwtResponse::class.java
        )
    ...
    fun addComment_asMember() {
        ...
        val url2 = generateUrl("/api/auth/signin")
        val secondResponse = restTemplate.postForEntity(
            url2, SignUpRequest("test2", "123", "test2@example.com"), JwtResponse::class.java
        )
    ...
    fun editComment_foreignComment() {
        ...
        val url2 = generateUrl("/api/auth/signin")
        val secondResponse = restTemplate.postForEntity(
            url2, SignUpRequest("test2", "test123", "test2@example.com"), JwtResponse::class.java
        )
