        ...
        MatcherAssert.assertThat(
            ...
            Matchers.matchesPattern(
                """User\(id = \d+ , username = testUser2 , password = 123 , """ +
                        """email = test\d@example.com , realName = Thomas Test , signUpDate = $regExDay $regExMonth \d+ \d+:\d+:\d+ """ +
                        """CET 202\d , lastLogInDate = null , bio = Short Bio , birthday = $regExDay $regExMonth 01 00:00:00 CET 1980 , """ +
