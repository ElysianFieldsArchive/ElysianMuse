...
| Name | Summary |
|---|---|
| [TemplateException](-template-exception/index.md) | [jvm]<br>class [TemplateException](-template-exception/index.md)(message: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html) = &quot;&quot;) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)<br>Exception thrown when a valid url can't be generated for a template (e.g. email confirm url) |