...
| [getSenderAddress](get-sender-address.md) | [jvm]<br>fun [getSenderAddress](get-sender-address.md)(): [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)<br>Getter for the current sender address used when sending mails. Can be changed by applying a new [MailerSettings](../../org.darkSolace.muse.mail.model/-mailer-settings/index.md). |
