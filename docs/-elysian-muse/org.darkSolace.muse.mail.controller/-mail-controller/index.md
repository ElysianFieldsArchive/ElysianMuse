...
| Name | Summary |
|---|---|
| [processEMailConfirmation](process-e-mail-confirmation.md) | [jvm]<br>@GetMapping(value = [&quot;/confirm/{code}&quot;])<br>fun [processEMailConfirmation](process-e-mail-confirmation.md)(@PathVariablecode: [String](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html)): ResponseEntity&lt;[Unit](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html)&gt;<br>Validates a users email address by a validation code sent to the provided email address. |
